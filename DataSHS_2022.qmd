---
title: |
  [Ecrire son code dans un environnement de programmation lettrée : le notebook]{.title}
subtitle: |
  [<img src="img/logo_notebook_o.png" width="600"/>]{.subtitle}
author: Hugues Pecout - UMR Géographie-Cités, CNRS
footer: |
...
<img src="img/users.png" style="float:left;margin-top:40px;" width="380"/>
...
<!-- <div class="fragment"> -->
<!-- <img src="img/users2.png" style="float:left;margin-top:10px;margin-left:60px;" width="186"/> -->
...
<!-- # {data-background="img/logo_notebook2.png" data-background-size="1000px"} -->
