...
#  {data-background="img/Literate_Programming_book_cover.jpg" data-background-size="600px"}
...
::: columns
::: {.column width="30%"}
![](img/logo_gt_notebook_orange.png){height="400"}
:::
...
![](img/Wolfram-Language-on-early-Mac.png){height="250"}
:::
...
::: small
**Jon Claerbout**, géophysicien, est l'un des premiers chercheur a exprimer le fait que **les méthodes de calcul menacent la reproductibilité de la recherche** si l'on ne donne pas un accès libre aux données et aux logiciels qui sous-tendent.

En 1976, Jon Claerbout publie un ouvrage référence dans le domùaine du traitement de signal : « ***Fundamentals of Geophysical Data Processing*** »

Cette 1ère version, non-reproductible, sera le début d'un long travail de recherche sur la reproductibilité de ses propres travaux... Via des notebooks !
:::
...
::: small
Le concept de **programmation lettrée** est pensé et mis en oeuvre (1977-78) par **Donald Knuth**. Le notebook se présente comme un outil idéal pour appliquer ce paradigme.
:::
:::
:::

#  {data-background="img/logo_notebook_orange.png" data-background-size="900px"}
...
::: {.nonincremental style="color:grey;font-size:18px;text-align:center;"}
-   *Article exécutable*
...
## [Une logique... des pratiques]{.smaller}
...
-\> Visualiser sur [HackMD](https://hackmd.io/MVFMDJaVTkKM-s4IUz_q7A?both)
...
<p style="font-size:40%;color:grey;margin-top:5px;">
