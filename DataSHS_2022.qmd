...
author: Hugues Pecout </br> [UMR Géographie-Cités - CNRS]{.affiliation}
footer: |
  Semaine Data SHS -Décembre 2022 - Université Paris-Cité
format:
  revealjs:
    incremental: true
...
iris$DISTCLASS <- cut(iris$Sepal.Length,
                      breaks = c(min(iris$Sepal.Length), 
                                 5, 6, 7, 
