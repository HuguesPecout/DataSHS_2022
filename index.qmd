...
::: bigbis
**Les notebooks et la programmation lettrée ont émergés à la même période, celle de l'émergence du concept de recherche reproductible...**
:::
:::
:::
:::
...
::: div1
::: left
[Programmation lettrée]{style="color:#3fb61840;"}
:::
...
[Reproductibilité ?]{style="color:#555919;"}
:::
...
➡️ [**Archivage et partage** (dépôt public ou privé)]{.orange}
:::
...
-   Ils permettent de [**déployer un notebook compilé en HTML**]{.orange} [**sur le web**]{.orange}
...
[Code source(GitHub) : <https://github.com/rCarto/Quarto>]{.big}\
[Notebook compilé : <https://rcarto.github.io/Quarto/>]{.big}
:::

##  {background-image="img/rstudio1.jpg"}

##  {background-image="img/rstudio3.jpg"}

##  {background-image="img/rstudio4.jpg"}

##  {background-image="img/rstudio5.jpg"}
...
-   Ajout bibliographie (BibTeX)

-   Ajout de CSS

-   Gestion des table de matière, note de bas de pages...
:::

Un **format de publication**<br> scientifique légitime
...
::: left3
Nombreux templates,<br>**multiples usages**
...
[**Diapositives libres** (CC BY-SA 4.0)]{.txt1}

[Diaporama :]{.txt2} [<https://huguespecout.github.io/DataSHS_2022/>]{.txt2}\
[Code source :]{.txt2} [<https://github.com/HuguesPecout/DataSHS_2022>]{.txt2}
...
[<img src="img/twitter.png" width="40" style="margin-top:15px;margin-bottom:-10px;margin-right:10px;"/>](https://gitlab.huma-num.fr/rzine/site)@rzine_shs
