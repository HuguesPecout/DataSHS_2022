...
::: div1
:::left
<span style="color:#3fb61840;" >Programmation lettrée</span>
:::
:::right
<span style="color:#f2a42340;">Notebook</span>
:::
:::
...
<span style="color:#555919;" >Reproductibilité ?</span>
::: 
...
<span style="color:#f2262340;" >Informations de session<br>et d'environnement</span>
:::
::: {.right2 auto-animate-delay="8.5"}
<span style="color:#2336f240;">Archivage & partage</br>Conditions d'utilisation</span>
:::
...
[Code source(GitHub) : [https://github.com/rCarto/Quarto](https://github.com/rCarto/Quarto)]{.big}  
[Notebook compilé : [https://rcarto.github.io/Quarto/](https://rcarto.github.io/Quarto/)]{.big}
