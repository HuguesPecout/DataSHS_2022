...
::: right3
[Equivalent LaTeX + [**programmation**]{.orange}]{.txt2} :
...
[Un [**format de publication**]{.orange}<br>scientifique légitime !]{.txt2}
...
# [Programmation lettrée, notebook et [reproductibilité]{.orange}]{.txt2}
...
[→ [**GitLab** ou **GitHub** (**Git**)]{.orange}]{.txt1}
...
[[**Informations session** :]{.txt1}]{.orange}
...
[<img src="img/twitter.png" width="35" style="margin-top:15px;margin-bottom:-10px;margin-right:10px;"/>](https://gitlab.huma-num.fr/rzine/site)[@rzine_shs]{.big}
:::
