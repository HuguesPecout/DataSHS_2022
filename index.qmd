...
::: right3
[Equivalent LaTeX + ]{.txt2}[**programmation**]{.orange} :
...
[Un ]{.txt2}[**format de publication**]{.orange}<br>scientifique légitime !
...
::: left3
[Nombreux templates,<br>]{.txt2}[**multiples usages**]{.orange} :
...
# [Programmation lettrée, notebook et ]{.txt2}[reproductibilité]{.orange}
...
::: {.absolute data-id="box4" auto-animate-delay="0" style="background: #2336f240;  width: 300px; height: 250px; margin-top: 350px; "}
:::
...
[→ ]{.txt1}[**GitLab** ou **GitHub** (**Git**)]{.orange}
...
[<img src="img/twitter.png" width="35" style="margin-top:15px;margin-bottom:-10px;margin-right:10px;"/>](https://gitlab.huma-num.fr/rzine/site)@rzine_shs
:::
